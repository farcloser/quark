// Package dag provides a generic directed acyclic graph for task scheduling.
// It supports dependency declaration and parallel execution of independent nodes.
package dag
