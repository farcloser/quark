...
var (
	...
	// ErrDigestMismatch indicates the digest in signature doesn't match expected digest.
	ErrDigestMismatch = errors.New("digest in signature does not match expected digest")
